...
@section('content')
    <div class="container">
        ...
        <div class="card shadow mt-3">
            <div class="card-body">
                <form action="{{ route('dokter.show', ['dokter' => $dokter->id]) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <!-- <div class="row"> -->
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="idDokter" type="text" name="idDokter"
                                    placeholder="ID Dokter" data-sb-validations="required" value="{{ $dokter->idDokter }}"
                                    disabled />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="tanggalLahir" type="date" name="tanggalLahir"
                                    ...
                                    value="{{ $dokter->tanggalLahir }}" disabled />
