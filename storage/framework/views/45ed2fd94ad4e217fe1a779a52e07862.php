<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="card shadow mt-3">
            <div class="card-body">
                <form action="<?php echo e(route('dokter.update', ['dokter' => $dokter->id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="idDokter" type="text" name="idDokter"
                                    ...
                                    value="<?php echo e($dokter->idDokter); ?>" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="tanggalLahir" type="date" name="tanggalLahir"
                                    ...
                                    value="<?php echo e($dokter->tanggalLahir); ?>" />
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rdjad\Documents\2023\Project\belajarlaravel\projectrumahsakit\resources\views/dokter/edit.blade.php ENDPATH**/ ?>