                        ...
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="namaPasien" name="namaPasien" type="text"
                                    ...
                                    value="<?php echo e($pasien->namaPasien); ?>" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="tanggalLahir" name="tanggalLahir" type="date"
                                    ...
                                    value="<?php echo e($pasien->tanggalLahir); ?>" />
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="alamatPasien" name="alamatPasien" type="text" placeholder="Alamat Pasien"
                                    style="height: 10rem;" data-sb-validations="required"><?php echo e($pasien->alamatPasien); ?></textarea>
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="kotaPasien" name="kotaPasien" type="text"
                                    ...
                                    value="<?php echo e($pasien->kotaPasien); ?>" />
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rdjad\Documents\2023\Project\belajarlaravel\projectrumahsakit\resources\views/pasien/edit.blade.php ENDPATH**/ ?>