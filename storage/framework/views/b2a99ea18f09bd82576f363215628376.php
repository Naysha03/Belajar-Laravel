            ...
            <form action="<?php echo e(route('ruangan.store')); ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="lokasi" type="text" placeholder="Lokasi" name="lokasi"
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rdjad\Documents\2023\Project\belajarlaravel\projectrumahsakit\resources\views/ruangan/create.blade.php ENDPATH**/ ?>