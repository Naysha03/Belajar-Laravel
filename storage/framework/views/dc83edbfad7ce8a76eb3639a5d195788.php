                        ...
                        <div class="col-12">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="kodeRuangan" type="text" name="kodeRuangan"
                                    ...
                                    value="<?php echo e($ruangan->kodeRuangan); ?>" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="namaRuangan" type="text" placeholder="Nama Ruangan"
                                    data-sb-validations="required" value="<?php echo e($ruangan->namaRuangan); ?>" name="namaRuangan" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="dayaTampung" type="text" name="dayaTampung"
                                    ...
                                    value="<?php echo e($ruangan->dayaTampung); ?>" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="lokasi" type="text" placeholder="Lokasi"
                                    name="lokasi" data-sb-validations="required" value="<?php echo e($ruangan->lokasi); ?>" />
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rdjad\Documents\2023\Project\belajarlaravel\projectrumahsakit\resources\views/ruangan/edit.blade.php ENDPATH**/ ?>